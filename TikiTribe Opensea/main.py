#sales, listings, floor-price check for Titan Tiki
#------------------------------------------------v2.1
#forcing hard-retries upon receiving corrupted api call responses 
...
async def embed_sender_lists(listobj, floor_price, channel):
    ...
    embed.set_footer(text='Tiki Quest NFT Bot', icon_url='https://lh3.googleusercontent.com/jiN2bFNr8UVGA7eXbeThd-rUa2GyCKgdZSFCpFRcQCVukLkm3hJNGw_QCCTl7hSr-Gfypx-eH9iAh5aLv9D2nbIzMJo8D1PTLHmx=s0')
...
async def floor(ctx):
    ...
    await ctx.channel.send(content=f'Current **Titan Tiki** floor price: {floor_price}Ξ')
